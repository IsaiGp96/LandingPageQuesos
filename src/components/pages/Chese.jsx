...
const products = [
    ...
    { id: 2, name: 'Ranchero', price: '90 MXN', image: '/src/assets/images/licuado.png' },
    { id: 3, name: 'Los pinos', price: '60 MXN', image: '/src/assets/images/jugo.png' },
    { id: 4, name: 'Asadero', price: '60 MXN', image: '/src/assets/images/jugo.png' },
  ];
